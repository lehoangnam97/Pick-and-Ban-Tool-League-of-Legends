...
namespace BanPickLol
{
    public partial class Form1 : Form
    {
        ...
        public Form1(int BanType, string _p1, string _p2, string _p3, string _p4, string _p5, string _p6, string _p7, string _p8, string _p9, string _p10)
        {
            ...
            label1.BackColor = Color.FromArgb(11, 132, 158);
        ...
        private static void DrawCross(Bitmap original)
        {
            ...
            for (int i = 0; i < mask.Width; i++)
            {
                for (int j = 0; j < mask.Height; j++)
                {
                    ...
                    {
                        original.SetPixel(i + original.Width / 2 - mask.Width / 2, j + original.Height - mask.Height, Color.FromArgb(190, 30, 55));
                    }
                }
            }
        }
        ...
        //    Pen pen = new Pen(Color.FromArgb(190,30,55), 5);
        //    int x1 = 0;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            arrbox[turn].BackColor = Color.Black;
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            //{
            //    Bitmap img = new Bitmap(pa + "\\ban\\" + currenName + "_Splash_0.png");
            //    //DrawCross(img);
            ...
            //        case 12:
            //        case 14:
            //            arrbox[turn].Image.RotateFlip(RotateFlipType.RotateNoneFlipX);
            //            break;
            //    }
            ...
            try
            {
                arrbox[turn].BackColor = Color.Black; // hiển thị vàng lượt tiếp theo
            }
            catch
            {
                a.Abort();
                ...
                res = 999;
                tableHeader.BackgroundImage = new Bitmap(BanPickLol.Properties.Resources.PickHeaderSwap);
            ...
            //tableHeader.BackgroundImage = new Bitmap(BanPickLol.Properties.Resources.PickHeaderBlue);
            if (banType == 0) // set vị trí của chữ "chọn tướng"
            {
                switch (turn)
                {
                    ...
                    case 4:
                        label1.BackColor = Color.FromArgb(11, 132, 158);
                        label1.Parent = panelleft;
                        tableHeader.BackgroundImage = new Bitmap(BanPickLol.Properties.Resources.PickHeaderBlue);
                        break;
                    case 3:
                    case 1:
                    case 5:
                        label1.BackColor = Color.FromArgb(190, 30, 55);
                        label1.Parent = panelright;
                        tableHeader.BackgroundImage = new Bitmap(BanPickLol.Properties.Resources.PickHeaderRed);
                        break;
                    case 6:
                    case 9:
                    case 10:
        ...
        private void listView1_Click(object sender, EventArgs e)
        {
            ...
            switch (turn)
            {
                ...
                case 15:
                    ...
                    path2 = pa + "\\ban\\" + selected + "_Splash_0.png";
                    try
                    {
                    ...
                    break;
                default:
                    string path = pa + "\\pick\\" + selected + "_Splash_0.png";       // tạo đường dẫn từ tên
                    try
                    {
            ...
            if (banType == 0) // set vị trí của chữ "chọn tướng"
            {
                switch (turn)
                {
                    ...
                    case 4:
                        ...
                        label1.Parent = panelleft;
                        //label2.BackColor = Color.FromArgb(11,132,158);
                        //tableHeader.BackgroundImage = new Bitmap(BanPickLol.Properties.Resources.PickHeaderBlue);
                        break;
                    case 3:
                    case 1:
                    case 5:
                        ...
                        label1.Parent = panelright;
                        //label2.BackColor = Color.FromArgb(190,30,55);
                        //tableHeader.BackgroundImage = new Bitmap(BanPickLol.Properties.Resources.PickHeaderRed);
                    ...
                    case 17:
                    case 18:
                        lblShape.Parent = arrbox[turn];
                        int curPos = Int32.Parse(arrbox[turn].Name.Length == 5 ? arrbox[turn].Name.Substring(4, 1) : arrbox[turn].Name.Substring(4, 2));
                        lbltest.Parent = arrbox[turn].Controls["labelName" + curPos];
                        lblShape.Dock = DockStyle.Right;
                        lblShape.BackColor = Color.FromArgb(11, 132, 158);

                        //lbltest.Location = new Point(65, 2);
                        lbltest.Dock = DockStyle.Right;
                        lbltest.TextAlign = ContentAlignment.TopRight;
                        // label1.Location = new Point(259, 4);
                        label1.Parent = panelleft;
                        //label2.BackColor = Color.FromArgb(11,132,158);
                        //tableHeader.BackgroundImage = new Bitmap(BanPickLol.Properties.Resources.PickHeaderBlue);
                    ...
                    default:
                        ...
                        {
                            lblShape.Parent = arrbox[turn];
                            lblShape.Dock = DockStyle.Left;
                            lblShape.BackColor = Color.FromArgb(190, 30, 55);

                            curPos = curPos = Int32.Parse(arrbox[turn].Name.Length == 5 ? arrbox[turn].Name.Substring(4, 1) : arrbox[turn].Name.Substring(4, 2));
                            lbltest.Parent = arrbox[turn].Controls["labelName" + curPos];
                            //lbltest.Location = new Point(5, 2);
                            //lbltest.Location = new Point(709, 99);

                            lbltest.Dock = DockStyle.Left;
                            lbltest.TextAlign = ContentAlignment.TopLeft;
                ...
                switch (turn)
                {
                    ...
                    default:
                        try
                        {
                            ...
                            lblShape.Dock = DockStyle.Left;
                            lblShape.BackColor = Color.FromArgb(190, 30, 55);
                            curPos = Int32.Parse(arrbox[turn].Name.Length == 5 ? arrbox[turn].Name.Substring(4, 1) : arrbox[turn].Name.Substring(4, 2));
                            lbltest.Parent = arrbox[turn].Controls["labelName" + curPos];
                            //lbltest.Location = new Point(5, 2);
                            lbltest.Dock = DockStyle.Left;
                            lbltest.TextAlign = ContentAlignment.TopLeft;
        ...
        private void Swap(object sender, EventArgs e)
        {
            ...
            TextBox temp = (TextBox)tableLayoutPanel1.Controls["SwapText" + name];
            int team = name[0] - 48;
            ...
            if (int.TryParse(temp.Text, out swapPosition))
            {
                if (swapPosition >= 1 && swapPosition <= 5)
                {
                    ...
                    swapPosition += team * 5;
                    PictureBox currentBox = (PictureBox)tableLayoutPanel1.Controls["panel" + currentPosition].Controls["pick" + currentPosition];
                    PictureBox swapBox = (PictureBox)tableLayoutPanel1.Controls["panel" + swapPosition].Controls["pick" + swapPosition];
